...
namespace Enemies
{
    public class Flamingo : Enemy
    {
        ...
        public Flamingo(string enemyName, Vector3 spawnPos, int id, Dictionary<int, Enemy> container, WaveConfig waveConfig) : base(enemyName, spawnPos, id, container, waveConfig)
        {
            range = 1.6f;
            range = range * range;
            ...
            selfPlayer.Role.Set(PlayerRoles.RoleTypeId.ChaosFlamingo, SpawnReason.ForceClass, PlayerRoles.RoleSpawnFlags.All);
        ...
        {
            selfPlayer.Role.Set(PlayerRoles.RoleTypeId.ChaosFlamingo, SpawnReason.ForceClass, PlayerRoles.RoleSpawnFlags.None);
            selfPlayer.EnableEffect<SpawnProtected>(1, true);
